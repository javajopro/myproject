 ...
 * Generated at: 2018-12-26 07:17:48 UTC
...
if(memberLoggedIn == null) {
 ...
 if(memberLoggedIn != null && "admin".equals(memberLoggedIn.getMemberId())) {
      ...
      out.write("\t//oName에는 한글, 공백 등 문자가 섞여 있을 수 있어서 인코딩 처리가 필요함.\r\n");
      out.write("\t//ie는 암묵적인 인코딩을 지원하지 않으므로 명시적인 인코딩이 필요함.\r\n");
	...
	System.out.println("commentList = "+commentList);
      ...
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<!-- 첨부파일이 있는 경우만 표시돼야함 -->\r\n");
      out.write("\t\t\t\t<a href=\"javascript:fileDownload(\r\n");
      out.write("\t\t\t\t\t\t\t'");
      out.print(b.getOrginalFileName() );
      out.write("',\r\n");
      out.write("\t\t\t\t\t\t\t'");
      ...
      out.write("\t\t\t\t\t <!-- 파일명 -->\r\n");
      out.write("\t\t\t\t\t ");
      out.print(b.getOrginalFileName()!=null?b.getOrginalFileName():"" );
      out.write("\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
 ...
 for(BoardComment bc: commentList) {
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t\t<!-- 실습문제 :\r\n");
      out.write("\t\t\t\t\t관리자이거나, 본인이 쓴 댓글(대댓글)에 대해서만 삭제버튼이 보여야 한다.\r\n");
      out.write("\t\t\t\t\t삭제요청처리후에는 현재페이지가 다시보여줘야 한다. -->\r\n");
      out.write("\t\t\t\t");
if(memberLoggedIn!=null 
						&& ("admin".equals(memberLoggedIn.getMemberId()) 
...
if(memberLoggedIn!=null 
      ...
      out.write("\t<!-- 댓글 끝 -->\r\n");
      out.write("\t<script>\r\n");
      out.write("\t//textarea click이벤트 핸들러\r\n");
      ...
      out.write("){\r\n");
      out.write("\t\t\tloginAlert();\r\n");
      out.write("\t\t\te.preventDefault(); //submit 방지\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//boardCommentContent 유효성검사\r\n");
      out.write("\t\tvar len = $(\"[name=boardCommentContent]\").val()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t .trim()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t .length;\r\n");
      out.write("\t\tif(len == 0){\r\n");
 ...
 if((memberLoggedIn!=null)&&(b.getBoardWriter().equals(memberLoggedIn.getMemberId())
      ...
      out.print(b.getBoardNo() );
      out.write("\" />\r\n");
      out.write("\t  <input type=\"hidden\" name=\"rName\"\r\n");
      out.write("\t  \t\t value=\"");
      out.print(b.getRenamedFileName() );
      out.write("\" />\r\n");
      out.write("</form>\r\n");
